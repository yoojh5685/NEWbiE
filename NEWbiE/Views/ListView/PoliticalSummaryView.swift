            ...
            HStack(spacing: 0) {
                ...
                Button(action: {
                    ...
                    Text("진보")
                        ...
                        .foregroundColor(selectedSide == .progressive_media_stance ? Color(hex: "#008AFF") : Color(hex: "#8D8D8D"))
                        .lineSpacing(3)
                        .kerning(-0.08)
                        ...
                        .background(
                            selectedSide == .progressive_media_stance ? Color.white : Color(hex: "#F4F4F4")
                        )
                        .cornerRadius(7)
                        .overlay(
                        ...
                        .shadow(
                            color: selectedSide == .progressive_media_stance ? Color.black.opacity(0.1) : .clear,
                            radius: 4, x: 0, y: 2
                        )
                }
                ...
                Button(action: {
                    ...
                    Text("보수")
                        ...
                        .foregroundColor(selectedSide == .conservative_media_stance ? Color(hex: "#FF4B41") : Color(hex: "#8D8D8D"))
                        .lineSpacing(5)
                        .kerning(-0.08)
                        .multilineTextAlignment(.center)
                        .padding(2)
                        .frame(maxWidth: .infinity, minHeight: 40)
                        .background(
                            selectedSide == .conservative_media_stance ? Color.white : Color(hex: "#F4F4F4")
                        )
                        .cornerRadius(7)
                        .overlay(
                            RoundedRectangle(cornerRadius: 7)
                        ...
                        .shadow(
                            color: selectedSide == .conservative_media_stance ? Color.black.opacity(0.1) : .clear,
                            radius: 4, x: 0, y: 2
                        )
                }
            }
